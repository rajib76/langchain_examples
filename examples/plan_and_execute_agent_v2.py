...
from typing import Optional, List, Set, Dict, Any, Mapping
...
llm = GPT4All(model="/Users/joyeed/Downloads/GPT4All-13B-snoozy.ggmlv3.q4_0.bin")
...
resp = agent.run("how far away between earth and sun? And if we need to get there in a week how fast we need to travel?")
print(resp)